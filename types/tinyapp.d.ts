// Type definitions for tinyapp v1.10.0

// 注意: 本文件中的定义仅用作typescript语法检查，业务代码中请勿依赖
...
declare interface IApp {
   ...
   */
  onLaunch?: (params?: my.IShowOptions) => void;

  /**
   * 生命周期函数--监听小程序显示。当小程序启动，或从后台进入前台显示，会触发 onShow
   */
  onShow?: (params?: my.IShowOptions) => void;
...
declare namespace my {
  ...
  export interface IShowOptions extends IData {
    query?: string;
    path?: string;
  }
   ...
   * 参考: https://docs.alipay.com/mini/api/can-i-use
   *
   ...
   * option 表示组件属性值
   */
  export function canIUse(query: string): boolean;

  export interface ICallOptions extends BaseOptions {
    [key: string]: any;
  }

  /**
   * 有两种格式my.call(apiName, {...options, success:function, fail:function, complete:function})
   * 有两种格式my.call(apiName, options, callback)
   * 参考: https://docs.antfin.com/tinyapp/develop/api
   */
  export function call(
    apiName: string,
    params?: ICallOptions,
    callback?: ((result: my.IData) => void)
  );

  // ---------------------------------- 系统能力 ----------------------------------

  export interface ClipBoardOptions extends BaseOptions {
    text?: string;
  }

  export interface ClipBoardReturnData {
    text?: string;
  }

  export function getClipboard(options: BaseOptions): ClipBoardReturnData;

  export function setClipboard(options: ClipBoardOptions): Promise;

  // ---------------------------------- 网络 ----------------------------------
  export interface RpcOptions extends BaseOptions {
    // RPC 服务名称
    operationType: string;
    // RPC 请求的参数
    requestData?: any[] | my.IData;
    // 设置 RPC 请求的头
    headers?: my.IData;
  ...
  export function rpc(
    options: string | RpcOptions,
    callback?: function
  ): Promise<my.IData | null>;
  // ---------------------------------- 基础 ----------------------------------

  export interface IAlertOptions extends BaseOptions {
    title?: string;
    content?: string;
    buttonText?: string;
  }
  ...
  // 备注: 不支持Promise
  export function alert(options: IAlertOptions | string);

  export interface IConfirmSuccessCallbackParam {
    // 是否地那就了确认
    confirm: boolean;
    // 是否点击了确认
    ok?: boolean;
  }
  export interface IConfirmOptions extends BaseOptions {
    title?: string;
    content?: string;
  ...
  export function confirm(options: IConfirmOptions): void;
  ...
  /**
   * 保留当前页面，跳转到应用内的某个页面，使用 `my.navigateBack` 可以返回到原页面。
   */
   ...
   * 版本: 基础库 1.4.0+ & 支付宝客户端 10.1.8+ 支持
   */
  export function reLaunch(options: NavigateBackOptions): void;
  export interface SetNavigationBarOptions extends BaseOptions {
    /**
     * 页面标题
     */
    title?: string;
   ...
   * 动态设置当前页面的标题。
   */
  export function setNavigationBar(options: SetNavigationBarOptions): void;
   ...
   * 显示消息提示框
   */
  export function showLoading(options: string | ShowLoadingOptions): Promise;
   ...
   * 显示消息提示框
   */
  export function hideLoading(options?: IHideLoadingOptions): Promise;
  ...
  export function getNetworkType(): Promise<GetNetworkTypeResult>;

  // ---------------------------------- 数据API列表 ----------------------------------

  export interface IStorageOperateAsyncSuccessParam {
    success: true;
  }

  export interface IStorageOperateAsyncCompleteParam {
    /**
     * 执行存储操作的页面路径
     */
    path?: string;
    ...
    referrerInfo?: {
      appId?: string;
      data?: string | my.IData;
      [key: string]: any;
    };
  }
  export interface IStorageOperateAsyncFailParam
    extends IStorageOperateAsyncCompleteParam {}

  export interface IStorageOperateAsyncOptions {
    success?: (res?: IStorageOperateAsyncSuccessParam) => void;

    fail?: (res?: IStorageOperationFailParam) => void;

    complete?: (res?: IStorageOperateAsyncCompleteParam) => void;
  }

  export interface SetStorageAsyncOptions extends IStorageOperateAsyncOptions {
    /**
     * 本地缓存中的指定的 key
     */
    key: string;
   ...
   */
  export function setStorage(options: SetStorageAsyncOptions): void;

  export interface IGetStorageAsyncSuccessParam
    extends IStorageOperateAsyncSuccessParam {
    /**
     * 对应的key
     */
    key?: string;
  ...
  export interface GetStorageOptions extends IStorageOperateAsyncOptions {
    /**
     * 本地缓存中的指定的 key
     */
    key: string;

    success?: (res?: IGetStorageAsyncSuccessParam) => void;
  }
  ...
  export interface GetStorageInfoOptions extends IStorageOperateAsyncOptions {
    /**
     * 接口调用的回调函数
     */
  ...
  export interface RemoveStorageOptions extends IStorageOperateAsyncOptions {
    /**
     * 本地缓存中的指定的 key
     */
    key: string;
   ...
   * 清理本地数据缓存。
   */
  export function clearStorage(options?: IStorageOperateAsyncOptions): void;

  // -------------存储对应的sync接口-----------
  export interface IStorageOperateSyncResult {
    /**
     * 执行结果
     */
    success?: boolean;
  ...
  export interface SetStorageSyncOptions {
    /**
     * 本地缓存中的指定的 key
     */
    key: string;
  ...
  export interface ISetStorageSyncResult extends IStorageOperateSyncResult {}
  /**
   * 将 data 存储在本地缓存中指定的 key 中，会覆盖掉原来该 key 对应的内容，这是一个同步接口。
   */
  export function setStorageSync(
    options: SetStorageSyncOptions
  ): ISetStorageSyncResult;

  export interface GetStorageSyncResult extends IStorageOperateSyncResult {
    /**
     * 对应的key
     */
    key?: string;
   ...
   */
  export function getStorageSync({ key: string }): GetStorageSyncResult;
  /**
   * 从本地缓存中同步获取指定 key 对应的内容。
   */
   ...
   * 从本地缓存中同步移除指定 key 。
   */
  export function removeStorageSync({ key: string }): IStorageOperateSyncResult;

  /**
   * 同步清理本地数据缓存。
   */
  export function clearStorageSync(): IStorageOperateSyncResult;

  export interface IDatePickerOptions extends BaseOptions {
    //返回的日期格式，默认 yyyy-MM-dd。支持 HH:mm:ss, yyyy-MM-dd, yyyy-MM-dd HH:mm:ss 三种格式
    formate?: 'yyyy-MM-dd' | 'HH:mm:ss' | 'yyyy-MM-dd HH:mm:ss';
    //初始选择的日期时间，默认当前时间
    currentDate?: string;
    //最小日期时间
    startDate?: string;
  ...
  export function datePicker(options: IDatePickerOptions): void;

  export interface IGetAuthCodeResult {
    authCode?: string;
  ...
  export interface IGetAuthCodeOptions extends BaseOptions {
    // 参考: https://docs.alipay.com/mini/api/openapi-authorize
    // 授权类型，默认 auth_base。支持 auth_base（静默授权）/ auth_user（主动授权） / auth_zhima（芝麻信用）
    scopes: 'auth_base' | 'auth_user' | 'auth_zhima' | string[];

    /**
     * 接口调用成功的回调函数
     */
    success?: (res?: IGetAuthCodeResult) => void;

    /**
     * 接口调用失败的回调函数
     */
    fail?: (error?: IGetAuthCodeResult) => void;
  ...
  export function getAuthCode(options?: IGetAuthCodeOptions);
  ...
  export interface GetImageInfoResult {
     ...
     * 方向
     */
    orientation: string; // up默认, down 180度旋转, left:逆时针旋转90度, right: 顺时针旋转90度,up-mirrored 同up但水平翻转, down-mirrored	同down但水平翻转,left-mirrored	同left但垂直翻转， right-mirrored	同right但垂直翻转
    /**
     * 图片的格式
     */
    type: string;
  ...
  export interface ISaveImageOptions extends BaseOptions {
    url: string;
  }

  export function saveImage(options: ISaveImageOptions): void;

  export interface ISetTransparentTitleOptions {
    // 参考: http://jsapi.alipay.net/alipayjsapi/index.html
    // auto: 自动隐藏(滚动过程中隐藏), always: 始终隐藏, none: 不隐藏
    transparentTitle: 'auto' | 'always' | 'custom' | 'none';
  }
  /**
   * 版本>10.1.25
   * 低版调用最好try/catch
   */
  export function setTransparentTitle(
    params: ISetTransparentTitleOptions
  ): void;

  /**
   * 上报业务埋点
   * 参考[使用]: https://docs.alipay.com/mini/api/report
   * 参考[文档]: https://docs.alipay.com/mini/data/eku6qh
   */
  export function reportAnalytics(eventName: string, params: IData);

  export interface IEventTargetInfo {
    /**
     * 实际触发事件的组件上由data-开头的自定义属性的集合
     */
    targetDataset: IData;
    /**
     * 标签名称
    ...
    tagName: string;
    /**
     * 绑定事件的组件上由data-开头的自定义属性的集合
     */
    dataset: {};
    /**
     * 当前元素起始位置距离文档起始位置左侧距离px
     */
    offsetLeft: number;
    /**
     * 当前元素起始位置距离文档起始位置顶距离px
     */
    offsetTop: number;
  }
  ...
  export interface ITouch {
    ...
    y?: number;
    /**
     * [View]距离页面可显示的区域（屏幕除去导航条）左边缘距离
     */
    clientX?: number;
    /**
     * [View]距离页面可显示的区域（屏幕除去导航条）上边缘距离
     */
    clientY?: number;
    /**
     * [View]唯一标识
    ...
    /**
     * [View]距离文档(Page)左边缘距离
     */
    pageX?: number;
    /**
     * [View]距离文档(Page)上边缘距离
     */
    pageY?: number;
  }
  /**
   * touch事件回调参数
   * 参考: https://docs.alipay.com/mini/framework/events
   */
  export interface ITouchEventParams {
    /**
     * 事件类型:
     */
    type:
     ...
     * 触发事件的源组件
     */
    target: IEventTargetInfo;
    /**
     * 事件传递过程中当前组件
     */
    currentTarget: IEventTargetInfo;
    /**
     * 当前停留在屏幕上的触摸点
     */
    touches: ITouch[];
  ...
  export interface IBoundingClientRectResult {
    // 单位: 像素
    right: number;
    left: number;
    top: number;
  ...
  export interface IScrollOffsetResult {
    scrollTop: number;
    scrollLeft: number;
  }

  export interface ISelectViewportResult {
    width: number;
    height: number;
  }

  export interface ISelectoryQueryCallbackParams
    extends IBoundingClientRectResult,
      IScrollOffsetResult,
      ISelectViewportResult {}

  export interface ISelectoryQueryCallback {
    (prams: ISelectoryQueryCallbackParams[]): void;
  }
  export interface ICreateSelectorQueryResult {
    select(query: string): ICreateSelectorQueryResult;
    selectAll(query: string): ICreateSelectorQueryResult;
    boundingClientRect(): ICreateSelectorQueryResult;
    selectViewport(): ICreateSelectorQueryResult;
    scrollOffset(): ICreateSelectorQueryResult;
    exec(callback: ISelectoryQueryCallback): void;
  }

  export function createSelectorQuery(): ICreateSelectorQueryResult;
  ...
  /**
   * 发起网络请求。`my.request`发起的是https请求。**一个支付宝小程序，同时只能有5个网络请求连接**。
   */
  ...
  /**
   * 开始录音。当主动调用 `my.stopRecord`，或者录音超过1分钟时自动结束录音，返回录音文件的临时文件路径。
   */
  ...
  /**
   * 暂停正在播放的语音。
   * 再次调用my.playVoice播放同一个文件时，会从暂停处开始播放。如果想从头开始播放，需要先调用 my.stopVoice。
   */
  ...
  export interface MapContext {
    /**
     * 获取当前地图中心的经纬度，返回的是 gcj02 坐标系，可以用于 my.openLocation
     */
  ...
  export interface IMakePhoenCallCallbackParams {
    success?: boolean;
    error?: number;
    errorMessage?: string;
  }
  export interface IMakePhoenCallCallback {
    (params?: IMakePhoenCallCallbackParams): void;
  }
  ...
  export function makePhoneCall(
    ...
    callback?: IMakePhoenCallCallback
  ): void;
   ...
   * 显示消息提示框
   */
  export function showToast(options: ShowToastOptions): Promise;
  ...
  export interface IMeasureTextResult {
    width: number;
  }
  ...
  export interface CanvasContext {
    ...
    measureText(string: content): IMeasureTextResult;
    /**
     * 设置纯色描边
     * @param color 设置为填充样式的颜色('rgb(255, 0, 0)'或'rgba(255, 0, 0, 0.6)'或'#ff0000'格式的颜色字符串)
     */
  ...
  export interface DrawCanvasOptions {
    ...
    /**
     * 绘图动作数组，由 my.createContext 创建的 context，调用 getActions 方法导出绘图动作数组。
     */
    actions: any[];
  ...
  export interface RequestPaymentOptions extends BaseOptions {
    ...
    /**
     * 签名,具体签名方案参见[支付宝公众号支付帮助文档](https://pay.weixin.qq.com/wiki/doc/api/jsapi.php?chapter=4_3&t=1477656495417)
     */
    paySign: string;
  }
